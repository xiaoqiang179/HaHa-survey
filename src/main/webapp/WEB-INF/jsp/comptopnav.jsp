        ...
        <div class="navbar-collapse collapse in">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown profile">
                    <a href="${pageContext.request.contextPath}/comp/tocompprofile" class="dropdown-toggle" data-toggle="dropdown">
                        <img class="profile-img img-thumbnail" src="${sessionScope.user.iconfilename}">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <ul class="action">
                            <li>
                                <a href="${pageContext.request.contextPath}/comp/tocompprofile">
                                    修改资料
                                </a>
                            </li>
                            <li>
...
<script type="text/javascript">
    $("#searchbtn").click(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/processsearch",
            type:"POST",
            data:{
                keyWord:$("#search").val()
            },
            success:function (data) {
                ...
                $.each(data,function (index,batch) {
                    var ele="<tr>\n" +
                        ...
                        "                                <td>"+batch.desp+"</td>\n" +
                        "                                <td><button type=\"button\" class=\"btn btn-default btn-xs btn-success\"><a href=\"${pageContext.request.contextPath}/doqust?batchID="+batch.id+"\" target=\"_blank\" style=\"color: white\">去做调查</a></button></td>\n" +
                        "                            </tr>"
