            ...
            <div class="app-body">
                ...
                <div class="app-block">
                    ...
                    <div class="app-form">
                        ...
                        <form action="${pageContext.request.contextPath}/user/signup" method="post" onsubmit="return check()">
                ...
                <span class="input-group-addon" id="basic-addon6">
                  <i class="fa fa-rss" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" placeholder="感兴趣的话题 多个以空格分开"
                                       aria-describedby="basic-addon2" name="likeword">
                            </div>
...
<script>
    ...
    $("#inname").change(function () {
        $.ajax({
            url: "${pageContext.request.contextPath}/user/checkok",
            type: "POST",
            data:{
                data:$("#inname").val(),
                type: "name"
